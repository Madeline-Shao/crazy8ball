...
STUDENT_LIBS = vector list polygon color body scene forces collision force_params force_wrapper collision_params game_state game_util game_setup power_effects
