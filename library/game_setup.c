...
void game_setup_add_stick(scene_t * scene) {
    ...
    body_t *cue_stick = body_init_with_info(stick_shape, INFINITY, (rgb_color_t) {1, 0, 0, 1}, ball_image, CUE_STICK_WIDTH, CUE_STICK_HEIGHT, "CUE_STICK", NULL);
...
void game_setup_add_table(scene_t *scene) {
    ...
    body_t *pool_table = body_init_with_info(rect, INFINITY, (rgb_color_t) {0,0,0,1}, table_image, TABLE_WIDTH, TABLE_HEIGHT, "POOL_TABLE", NULL);//magic numbers
...
void game_setup_add_walls(scene_t *scene) {
    ...
    body_t *wall_top1 = body_init_with_info(wall_shape_top1, INFINITY, (rgb_color_t){0, 1, 0, 1}, NULL, wall_width, WALL_THICKNESS, "WALL", NULL);
    ...
    body_t *wall_top2 = body_init_with_info(wall_shape_top2, INFINITY, (rgb_color_t){0, 1, 0, 1}, NULL, wall_width, WALL_THICKNESS, "WALL", NULL);
    ...
    body_t *wall_bot1 = body_init_with_info(wall_shape_bot1, INFINITY, (rgb_color_t){0, 1, 0, 1}, NULL, wall_width, WALL_THICKNESS, "WALL", NULL);
    ...
    body_t *wall_bot2 = body_init_with_info(wall_shape_bot2, INFINITY, (rgb_color_t){0, 1, 0, 1}, NULL, wall_width, WALL_THICKNESS, "WALL", NULL);
    ...
    body_t *wall_right = body_init_with_info(wall_shape_right, INFINITY, (rgb_color_t){0, 1, 0, 1}, NULL, WALL_THICKNESS, wall_height, "WALL", NULL);
    ...
    body_t *wall_left = body_init_with_info(wall_shape_left, INFINITY, (rgb_color_t){0, 1, 0, 1}, NULL, WALL_THICKNESS, wall_height, "WALL", NULL);
